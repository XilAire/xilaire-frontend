                ...
                <>
                  <div>
                    ...
                    <p className="mt-3 text-sm leading-6 text-[var(--text-muted)]">
                      ...
                      Budget account. We will send
                      you a secure password-reset
                      link.
                    </p>
                  </div>
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        not confirm whether an account
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-[var(--text-muted)]">
              ...
              Reset links expire for security, so
              request another one if the link is no
              longer valid.
            </p>
          </div>
        </div>
      ...
      <div className="relative z-10">
        ...
        <div className="mt-16 max-w-xl">
          ...
          <h2 className="mt-5 text-4xl font-bold leading-tight tracking-tight xl:text-5xl">
            Get back to your financial plan
            securely.
          </h2>

          <p className="mt-6 max-w-lg text-base leading-7 text-white/80 xl:text-lg">
            CASE Budget protects your financial
            workspace with secure recovery links,
            session controls, and optional
