  ...
  return (
    ...
    >
      ...
      <LegalSection title="1. Information we collect">
        ...
        <LegalList>
          <li>Account information such as name, email address, authentication identifiers, profile details, and account preferences.</li>
          <li>Learning information such as enrollments, lesson progress, assessment attempts, scores, completion status, and certificates.</li>
          <li>Subscription and transaction metadata needed to manage paid services. Payment-card details may be processed by our payment provider rather than stored directly by CASE University.</li>
          <li>Technical information such as device, browser, IP address, timestamps, diagnostic events, and security logs.</li>
          <li>Communications and support information you voluntarily provide.</li>
        </LegalList>
      </LegalSection>
      ...
      <LegalSection title="2. How we use information">
        <LegalList>
          ...
          <li>Maintain course enrollment, progress, assessments, and certificates.</li>
          <li>Manage subscriptions, entitlements, billing status, and customer support.</li>
          <li>Detect fraud, abuse, unauthorized access, and technical problems.</li>
          <li>Improve platform reliability, usability, curriculum, and learner experience.</li>
      ...
      <LegalSection title="3. How information may be shared">
        <p>
          ...
          operate the platform, subject to appropriate contractual or legal
          protections.
        </p>
        <p>
          Information may also be disclosed when required by law, to protect
          rights or safety, in connection with a corporate transaction, or when
          you direct or authorize us to share it.
        </p>
      </LegalSection>
      ...
      <LegalSection title="4. Learning records and certificates">
        <p>
          ...
          certificate is valid. We design public verification to avoid exposing
          unnecessary account identifiers or contact information.
        </p>
      </LegalSection>
      ...
      <LegalSection title="6. Your choices and rights">
        <p>
          ...
          personal information. Requests may require identity verification.
          See our Data Deletion page for deletion instructions.
        </p>
      </LegalSection>
      ...
      <LegalSection title="10. Contact">
        <p>
          Privacy questions and requests can be submitted through the contact
          information listed in the CASE University Legal Center.
        </p>
      </LegalSection>
    </LegalDocument>
  );
