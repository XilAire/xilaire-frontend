...
export default function DisclaimerPage() {
  return (
    <LegalDocument
      ...
      description="Important information about the educational nature of CASE University and the risks associated with investing, trading, securities, and options."
    >
      <LegalNotice>
      ...
      <LegalSection title="3. Investing and trading involve risk">
        <LegalList>
          ...
          <li>Market conditions can change rapidly and historical examples may not reflect current conditions.</li>
          <li>Short-term trading can involve substantial volatility, costs, taxes, and execution risk.</li>
          <li>Margin can magnify both gains and losses and may result in forced liquidation or losses exceeding the amount initially committed in some circumstances.</li>
        </LegalList>
      </LegalSection>
