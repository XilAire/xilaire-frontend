    ...
    >
      ...
      <LegalSection title="How to request deletion">
        <p>
          ...
          <Link href="/legal/contact" className="font-bold text-[var(--primary)] hover:underline">
            Legal Contact
          </Link>{" "}
      ...
      <LegalSection title="Information that may be deleted or de-identified">
        <LegalList>
          ...
          <li>Assessment attempts and course-enrollment records, where deletion is legally and operationally permitted.</li>
          <li>Other account-linked information that is not required to be retained.</li>
        </LegalList>
      </LegalSection>

      <LegalSection title="Information we may retain">
        <LegalList>
          <li>Records required by law, accounting, tax, payment, dispute, or regulatory obligations.</li>
          <li>Security, fraud-prevention, audit, and abuse-prevention records.</li>
          <li>Backups that are isolated from ordinary production use until overwritten according to applicable retention processes.</li>
          <li>Information that has been aggregated or de-identified so it no longer reasonably identifies you.</li>
        </LegalList>
      </LegalSection>
