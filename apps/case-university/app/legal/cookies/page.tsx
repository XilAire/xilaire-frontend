    ...
    >
      <LegalSection title="1. What cookies are">
        <p>
          ...
          technologies may include browser storage, pixels, SDKs, or
      ...
      <LegalSection title="2. How CASE University may use them">
        <LegalList>
          ...
          <li>
            Remember essential preferences such as interface or session
            settings.
          </li>
          <li>
            Protect the platform against fraud, abuse, and unauthorized access.
          </li>
          <li>
            Measure reliability, diagnose errors, and understand platform
            performance.
          </li>
