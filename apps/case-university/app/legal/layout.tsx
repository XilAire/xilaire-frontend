...
export const metadata: Metadata = {
  ...
  description:
    "Privacy, terms, disclosures, security, data rights, and legal information for CASE University.",
};
        ...
        <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          ...
          >
            ...
            <span className="min-w-0">
              ...
              <span className="mt-0.5 block truncate text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--text-muted)]">
                Legal Center
              </span>
            </span>
          </Link>
