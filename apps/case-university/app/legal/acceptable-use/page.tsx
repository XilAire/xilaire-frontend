  ...
  return (
    ...
    >
      ...
      <LegalSection title="Prohibited activities">
        <LegalList>
          <li>
            Attempting to gain unauthorized access to accounts, databases,
            administrative tools, infrastructure, or restricted features.
          </li>
          <li>
            Bypassing subscriptions, entitlements, security controls, rate
            limits, or technical restrictions.
          </li>
          <li>
            Introducing malware, malicious code, automated attacks, or
            disruptive traffic.
          </li>
          <li>
            Using the service for fraud, impersonation, deception, harassment,
            unlawful discrimination, or other illegal conduct.
          </li>
          <li>
            Copying, scraping, reselling, republishing, or redistributing
            protected curriculum or assessments beyond rights expressly granted
            to you.
          </li>
          <li>
            Sharing account credentials or paid access in a way that defeats
            account or subscription restrictions.
          </li>
          <li>
            Manipulating assessments, certificates, progress records, or
            verification systems.
          </li>
          <li>
            Using CASE University branding or certificates to falsely claim
            professional licensing, accreditation, endorsement, or investment
            expertise.
          </li>
        </LegalList>
      </LegalSection>
