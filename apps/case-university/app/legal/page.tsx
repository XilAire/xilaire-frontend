    ...
    documents: [
      {
        ...
        description:
          "How information is collected, used, shared, retained, and protected.",
      },
      {
        href: "/legal/cookies",
        title: "Cookie Policy",
        description:
          "How cookies and similar technologies may be used across the platform.",
      },
      {
        href: "/legal/security",
        title: "Security",
        description:
          "Our approach to protecting accounts, learner records, and platform data.",
      },
      {
        href: "/legal/data-deletion",
        title: "Data Deletion",
        description:
          "How to request deletion of eligible CASE University account information.",
      },
    ],
  },
  {
    ...
    description:
      "Rules governing access to CASE University and use of the learning platform.",
    documents: [
      {
        href: "/legal/terms",
        title: "Terms of Service",
        description:
          "The agreement governing your access to and use of CASE University.",
      },
      {
        href: "/legal/acceptable-use",
        title: "Acceptable Use Policy",
        description:
          "Activities that are permitted and prohibited on the platform.",
      },
      {
        href: "/legal/disclaimer",
        title: "Educational & Investment Disclaimer",
        description:
          "Important disclosures about education, investing, trading, options, and financial risk.",
      },
    ],
  },
  {
    ...
    description:
      "Third-party material, intellectual-property information, and legal contact resources.",
    documents: [
      {
        href: "/legal/licenses",
        title: "Licenses & Attributions",
        description:
          "Third-party software, content, trademarks, and attribution information.",
      },
      {
        href: "/legal/contact",
        title: "Legal Contact",
        description:
          "How to contact CASE University about legal, privacy, data, or security matters.",
      },
    ],
  },
];
              ...
              {section.documents.map((document) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <h3 className="font-extrabold text-[var(--text-primary)] transition group-hover:text-[var(--primary)]">
                        {document.title}
                      </h3>
