    ...
    >
      ...
      <LegalSection title="When contacting us">
        <LegalList>
          ...
          <li>Provide the email address associated with your account when account verification is needed.</li>
          <li>Describe the request clearly, such as Privacy Request, Data Deletion, Security Report, or Copyright/Trademark Inquiry.</li>
          <li>Provide only the information reasonably necessary for us to understand and process the request.</li>
        </LegalList>
      </LegalSection>
