  ...
  return (
    ...
    >
      ...
      <LegalSection title="Our security approach">
        <LegalList>
          <li>Authentication and authorization controls designed to restrict access to protected functionality.</li>
          <li>Role-based restrictions for administrative capabilities.</li>
          <li>Database access controls and server-side enforcement for sensitive learning and entitlement operations.</li>
          <li>Encrypted network connections where supported by our infrastructure and service providers.</li>
          <li>Logging, monitoring, validation, and error handling intended to detect or reduce misuse.</li>
          <li>Use of specialized service providers for infrastructure, authentication, payments, and communications.</li>
        </LegalList>
      </LegalSection>
