...
export async function closeExecution({
  ...
  /* -------------------------------------------------
     ...
     exit_value, pnl, and pnl_pct are generated by PostgreSQL and must not
     be assigned by the application. Updating exit_price and lifecycle fields
     allows the database to recalculate those generated values.
  ------------------------------------------------- */
